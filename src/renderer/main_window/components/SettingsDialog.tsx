...
import { Languages, Zap, Settings2, Palette, Monitor } from "lucide-react";
...
type SettingsSection = "general" | "personalization" | "system";
  ...
  const sidebarItems = [
    {
      ...
      label: "General",
      icon: Settings2,
      description: "Output settings and AI features",
    },
    {
      id: "personalization" as const,
      label: "Personalization",
      icon: Palette,
      description: "Language and translation options",
    },
    {
      id: "system" as const,
      label: "System Settings",
      icon: Monitor,
      description: "Data management and statistics",
    },
  ];
